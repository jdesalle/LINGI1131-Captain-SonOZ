...
%---------------Jeu-------------
  ...
  % thread%J'ai rajoute un thread, pas sur qu'il faille je crois pas, a moins qu'a un moment on impl�mente la possibilit� de jouer plusieur partie, et alors il serait avant
   local
      Winner
   in
